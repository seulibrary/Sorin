defmodule ApiWeb.CollectionView do
    ...
    def render("collection.json", %{collection: collection}) do
        files = if Map.has_key?(collection, :files) do
        ...
        notes = if Map.has_key?(collection, :notes) do
        ...
        resources = if Map.has_key?(collection, :resources) do
    ...
    def render("resource.json", %{collection: rec}) do
        files = if Map.has_key?(rec, :files) do
        ...
        notes = if Map.has_key?(rec, :notes) do
